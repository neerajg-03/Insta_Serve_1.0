...
import { XMarkIcon, ShieldCheckIcon, ClockIcon, PlayIcon } from '@heroicons/react/24/outline';
...
const StartCodeModal: React.FC<StartCodeModalProps> = ({
  isOpen,
  onClose,
  bookingId,
  serviceTitle,
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      setTimeRemaining(prev => {
        if (prev <= 1) {
          toast.error('Code expired. Please wait for provider to generate a new code.');
          onClose();
          return 0;
        }
        return prev - 1;
        ...
        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 px-6 py-4 rounded-t-2xl">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-xl font-bold text-white">Service Start Code</h3>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6">
          ...
          <div className="mb-6 text-center">
            ...
            <div className="bg-gradient-to-r from-blue-100 to-indigo-100 border-2 border-blue-300 rounded-xl p-4">
              <div className="flex items-center justify-center space-x-3">
                <span className="text-3xl font-bold text-blue-800 tracking-wider font-mono">
                  {startCode}
                </span>
                <button
          ...
          <div className="mb-6 p-4 bg-amber-50 rounded-lg border border-amber-200">
            ...
            <p className="text-xs text-amber-700">
              Your service provider will enter this code to confirm and start the service. 
