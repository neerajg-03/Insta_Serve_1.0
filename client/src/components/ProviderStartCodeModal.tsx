...
import { XMarkIcon, PlayIcon, ShieldCheckIcon, ExclamationTriangleIcon } from '@heroicons/react/24/outline';
import toast from 'react-hot-toast';

interface ProviderStartCodeModalProps {
  isOpen: boolean;
  onClose: () => void;
  bookingId: string;
  serviceTitle: string;
...
const ProviderStartCodeModal: React.FC<ProviderStartCodeModalProps> = ({
  isOpen,
  onClose,
  bookingId,
  serviceTitle,
        ...
        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 px-6 py-4 rounded-t-2xl">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-xl font-bold text-white">Start Service</h3>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6">
            ...
            <div className="flex items-start space-x-2">
              ...
              <div>
                ...
                <ol className="text-xs text-amber-700 space-y-1 list-decimal list-inside">
                  <li>Click "Generate Code" to create a 6-digit start code</li>
                  <li>Share the code with your customer</li>
                  <li>Customer will provide the code for verification</li>
                  <li>Enter the code below to start the service</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6 text-center">
            <button
              ...
              disabled={loading || codeGenerated}
              className="px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-lg hover:from-blue-600 hover:to-indigo-700 transition-all font-medium shadow-lg hover:shadow-xl transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center mx-auto"
            >
              {loading ? (
                <>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="XXX-XXX"
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-center text-lg font-mono font-bold tracking-wider"
                    maxLength={7}
                  />
                  {inputCode.length === 0 && (
...
export default ProviderStartCodeModal;
