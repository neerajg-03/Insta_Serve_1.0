...
interface RouteData {
  distance: {
    text: string;import React, { useState, useEffect, useRef } from 'react';
            ...
            <>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <button
                  ...
                  className="bg-blue-600 text-white px-4 py-3 rounded-lg hover:bg-blue-700 transition-colors font-medium flex items-center justify-center text-sm"
                >
