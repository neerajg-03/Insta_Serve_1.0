    ...
    new GoogleStrategy(
      ...
      async (accessToken, refreshToken, profile, done) => {
        try {
          ...
          console.log('Callback URL configured:', process.env.GOOGLE_CALLBACK_URL || 'http://localhost:5000/api/auth/google/callback');
          ...
          // Generate unique placeholder phone using timestamp to avoid duplicate key errors
          const uniquePlaceholderPhone = '999' + Date.now().toString().slice(-7);
          ...
          const newUser = new User({
            ...
            password:
              ...
              'Google123!',
            phone: uniquePlaceholderPhone, // Unique placeholder - will be updated
