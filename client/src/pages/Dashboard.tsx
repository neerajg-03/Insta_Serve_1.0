...
const Dashboard: React.FC = () => {
  ...
  const fetchBookings = async () => {
    try {
      ...
      // Filter out cancelled bookings (including those cancelled due to timeout)
      const activeBookings = (response.bookings || []).filter((booking: Booking) => booking.status !== 'cancelled');
